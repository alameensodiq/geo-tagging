...
import { ClientWelfare } from "../../Store/Apis/ClientWelfare";

const ClientAdminWelfare = ({ title }) => {
  ...
  useEffect(() => {
    ...
    dispatch(ClientWelfare({ startDate }));
    // if (reload) {
    //   // dispatch(CorporateBusinessRep())
    //   setReload(false);
    // }
  ...
  const { clientwelfare, authenticatingclientwelfare } = useSelector(
    (state) => state.clientwelfare
  );
  console.log(clientwelfare);
      ...
      <div className="maincontainer">
        <div className="firstdiv">
          <div className="backbutton">
            ...
            <span className="name">
              Welfare Report:{" "}
              {sessionStorage.getItem("emoji") === "angry"
                ? "😡"
                : sessionStorage.getItem("emoji") === "sideview"
                ? "😏"
                : sessionStorage.getItem("emoji") === "sad"
                ? "😌"
                : sessionStorage.getItem("emoji") === "smile"
                ? "😊"
                : "😃"}
            </span>
          </div>
        ...
        <div className="table">
          ...
          <Tables
            ...
            reportwelfare
            setreporter={setreporter}
            data={clientwelfare?.data?.IncidentsCheck?.incidentsFree}
            setStep={setStep}
          />
        </div>
      </div>
...
export default ClientAdminWelfare;
