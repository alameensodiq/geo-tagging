        ...
        <div className="firstdiv">
          <div className="backbutton">
            <Goback
              ...
              onClick={() => navigate(-1)}
            />
            <span className="name">Welfare Reports 😡 Angry</span>
          </div>
        </div>
        <div className="table">
          ...
          <Tables reportemoji data={activate} setStep={setStep} />
        </div>
      </div>
    </Flex>
  );
...
export default ClientAdminEmoji;
