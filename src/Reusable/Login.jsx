...
import { audit, corporate, superadmins, supersub, superusers } from "../Routes";
...
const Login = () => {
  ...
  if (
    ...
    if (savedPermissions && savedPermissions.includes("OVERVIEW_VIEW")) {
      ...
      navigate(`${superadmins}/${supersub}`);
    } else if (
      savedPermissions &&
      (savedPermissions.includes("USER_VIEW") ||
        savedPermissions.includes("USER_CREATE"))
    ) {
      navigate(`${superadmins}/${superusers}`);
    } else {
      navigate(`${superadmins}/${audit}`);
    }
  } else if (
    corporateuser?.status &&
    !authenticating &&
    ...
    navigate("/superadmin-changepassword");
  }
